...
class DCRNNSupervisor(object):
    ...
    def _get_log_dir(kwargs):
        ...
        if log_dir is None:
            ...
            if filter_type == 'random_walk':
                ...
                filter_type_abbr = 'DR'
            run_id = '{:d}_{:d}_{:d}_{:.2f}_{:.3f}_{:d}_{}'.format(
    ...
    def _train(self, sess, base_lr, epoch, steps, patience=50, epochs=100,
        ...
        while self._epoch <= epochs:
            ...
            end_time = time.time()
            message = 'Epoch [{}/{}] ({}) train_loss: {:.4f}, val_loss: {:.4f}, train_mae: {:.4f}, val_mae: {:.4f} lr:{:.4f} {:.1f}s'.format(
                self._epoch, epochs, global_step, train_loss, val_loss, train_mae, val_mae, new_lr, (end_time - start_time))
